#include "LoaderMenuListT6.h"

#include "Game/T6/T6.h"
#include "Game/T6/Menu/MenuConversionZoneStateT6.h"
#include "Game/T6/Menu/MenuConverterT6.h"
...
namespace
{
    ...
    private:
        ...
        {
            menu::MenuFileReader reader(stream, menuFileName, menu::FeatureLevel::T6, m_search_path);
...
namespace menu
{
    std::unique_ptr<AssetCreator<AssetMenuList>> CreateMenuListLoaderT6(MemoryManager& memory, ISearchPath& searchPath)
    {
